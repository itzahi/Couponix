 ...
 <!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <ul class="nav navbar-nav navbar-right navbar-user">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Add Business<small></small></h1>
            <ul class="breadcrumb">
		...
		<div class="row">
          <div class="col-lg-6">
            <form role="form" action="${pageContext.request.contextPath}/CouponsController/adminController" name="addBusinessForm"  method="POST" onsubmit="return checkForm();" >
	  		  <input type="hidden" name="controller" class="form-control" value="addBusiness" >
		      ...
		      <div class="form-group">
                ...
                <input type="text" name="businessName" class="form-control" placeholder="Enter text">
              </div>
		      <div class="form-group">
                <label>Phone</label>
		      ...
		      <div class="form-group">
                <label>Adress</label>
                <input type="text" name="adress" class="form-control" placeholder="Enter text">
              </div>
  ...
  function checkForm()
  {
    var id = document.addBusinessForm.id.value;                     //ID describes the ID of the business and is unique for every business 
    var businessName = document.addBusinessForm.businessName.value; //Name describes the name of the business adding to a database
    var phone = document.addBusinessForm.phone.value;				//Phone describes the business phone number added to a database
    var adress = document.addBusinessForm.adress.value;				//Address describes the business's address added to a database
	...
	var flag = true;												//flag describes if  all details are valid or not 
		...
		if ((isEmpty(id)) == true ||(checkString(okNum, id)) == false)
		{
			 ...
			 document.addBusinessForm.id.value;
			 flag = false;
		}
		...
		if ((isEmpty(businessName)) == true)
		{
			 ...
			 document.addBusinessForm.businessName.value;
			 flag = false;
		}
		...
		if ((isEmpty(phone)) == true ||(checkString(okNum, phone)) == false)
		{
			 ...
			 document.addBusinessForm.phone.value;
			 flag = false;
		}
		...
		if ((isEmpty(adress)) == true)
		{
			 ...
			 document.addBusinessForm.adress.value;
			 flag = false;
		}
