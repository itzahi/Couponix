 ...
 <!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <ul class="nav navbar-nav navbar-right navbar-user">
      ...
      <div id="page-wrapper">
		...
		<div class="row">
          <div class="col-lg-6">
            <form role="form" action="${pageContext.request.contextPath}/CouponsController/adminController" name="addCategoryForm"  method="POST" onsubmit="return checkForm();" >
	  		  <input type="hidden" name="controller" class="form-control" value="addCategory" >
  ...
  function checkForm()
  {
	    var id = document.addCategoryForm.id.value;                       	//ID describes the ID of the Category and is unique for every Category 
	    var categoryName = document.addCategoryForm.categoryName.value;	  	//categoryName describes the name of the Category adding to a database
	    var categoryImage = document.addCategoryForm.categoryImage.value;	//categoryImage describes the image/icon of  Category adding by url to  database
		...
		var flag = true;													//flag describes if  all details are valid or not 
			...
			if ((isEmpty(id)) == true ||(checkString(okNum, id)) == false)
			{
				 ...
				 document.addCategoryForm.id.value;
				 flag = false;
			}
			...
			if ((isEmpty(categoryName)) == true)
			{
				 ...
				 document.addCategoryForm.categoryName.value;
				 flag = false;
			}
			...
			if ((isEmpty(categoryImage)) == true  || isValidURL(categoryImage) == false)
			{
				 ...
				 document.addCategoryForm.categoryImage.value;
				 flag = false;
			}
