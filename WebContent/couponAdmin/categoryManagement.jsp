...
<%-- this JSP page  is managed by the Admin, Responsible for the actions links belong to Category--%>       
	  <head>   
           	<%
  		...
  		%>
              ...
              <title>Category Management - Couponic Admin</title>
    ...
    <ul class="nav navbar-nav navbar-right navbar-user">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Dashboard <small>Couponic Admin Panel</small></h1>
            <ol class="breadcrumb">
            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                ...
                <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/couponAdmin/addCategory.jsp">Add New Category</a>
                    </div>
                    <div class="col-xs-6 text-right">
                    <a href="${pageContext.request.contextPath}/couponAdmin/addCategory.jsp""><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-lg-3">
            <div class="panel panel-warning">
              ...
              <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/couponAdmin/deleteCategory.jsp">Delete Category</a>
                    </div>
                    <div class="col-xs-6 text-right">
                    <a href="${pageContext.request.contextPath}/couponAdmin/deleteCategory.jsp"><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
            </div>
              ...
              <div class="panel-heading">
                <div class="row">
                 ...
                 <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/couponAdmin/updateCategory.jsp">Category Update</a>
                    </div>
                    <div class="col-xs-6 text-right">
                    <a href="${pageContext.request.contextPath}/couponAdmin/updateCategory.jsp"><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
            </div>
