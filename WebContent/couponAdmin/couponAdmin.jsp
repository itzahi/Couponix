<%@ page language="java" contentType="text/html; charset=windows-1255" pageEncoding="windows-1255"%>
 ...
 <%-- this JSP page  is managed by the Admin, Responsible for the actions links belong to main page--%>    
   <head>   
           	<%
  		...
  		%>
              ...
              <title>Dashboard - Couponic Admin</title>
            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                ...
                <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/couponAdmin/couponManagement.jsp"> Coupon Managment</a>
                    </div>
                    <div class="col-xs-6 text-right">
                    <a href="${pageContext.request.contextPath}/couponAdmin/couponManagement.jsp"><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-lg-3">
            <div class="panel panel-warning">
              ...
              <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/couponAdmin/businessManagement.jsp"> Business Management</a>
                    </div>
                    <div class="col-xs-6 text-right">
                    <a href="${pageContext.request.contextPath}/couponAdmin/businessManagement.jsp"><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
            </div>
              ...
              <div class="panel-heading">
                <div class="row">
                 ...
                 <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/couponAdmin/categoryManagement.jsp"> Category Managment</a>
                    </div>
                    <div class="col-xs-6 text-right">
                    <a href="${pageContext.request.contextPath}/couponAdmin/categoryManagement.jsp"><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
            </div>
