<%@ page language="java" contentType="text/html; charset=windows-1255" pageEncoding="windows-1255"%>
 ...
 <%-- this JSP page  is managed by the Admin, Responsible for the actions links belong to Coupon--%> 
	 <head>   
           	<%
  		...
  		%>
              ...
              <title>Coupon Management - Couponic Admin</title>
            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                ...
                <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/CouponsController/addCouponInit">Add New Coupon</a>
                    </div>
                    <div class="col-xs-6 text-right">
                    <a href="${pageContext.request.contextPath}/CouponsController/addCouponInit"><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-lg-3">
            <div class="panel panel-warning">
              ...
              <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/couponAdmin/deleteCoupon.jsp">Delete Coupon</a>
                    </div>
                    <div class="col-xs-6 text-right">
                    <a href="${pageContext.request.contextPath}/couponAdmin/deleteCoupon.jsp"><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
            </div>
              ...
              <div class="panel-heading">
                <div class="row">
                 ...
                 <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                     <a href="${pageContext.request.contextPath}/CouponsController/updateCouponInit">Coupon Update</a>
                    </div>
                    <div class="col-xs-6 text-right">
