<%@ page language="java" contentType="text/html; charset=windows-1255"
 ...
 <!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	  ...
	  <%-- this JSP page  is managed by the Admin, responsible for Delete proper business 
	 ...
	 <head>   
         ...
         // checking if username seesion is open, it redirect to login 
  		...
  		%>
              ...
              <title>Delete Business - Couponic Admin</title>
 ...
 <!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <ul class="nav navbar-nav navbar-right navbar-user">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Delete Business<small></small></h1>
            <ul class="breadcrumb">
		...
		<div class="row">
          <div class="col-lg-6">
  <form role="form" action="${pageContext.request.contextPath}/CouponsController/adminController" name="deleteBusinessForm"  method="POST" onsubmit="return checkForm();" >
	  		  <input type="hidden" name="controller" class="form-control" value="deleteBusiness" >
	  		  <input type="hidden" name="className" value="Business"> 
 ...
 function checkForm()
	  {
	    var id = document.deleteBusinessForm.id.value; 		//ID describes the ID of the Business to delete
		...
		var flag = true;									//flag describes if  all details are valid or not 
			...
			if ((isEmpty(id)) == true ||(checkString(okNum, id)) == false)
			{
				 ...
				 document.deleteBusinessForm.id.value;
				 flag = false;
			}
