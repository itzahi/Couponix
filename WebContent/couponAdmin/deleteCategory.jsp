<%@ page language="java" contentType="text/html; charset=windows-1255"
 ...
 <%-- this JSP page  is managed by the Admin, responsible for Delete proper Category 
		by check if Category id exist and send it to servlet Treatment. --%>      
	  <head>   
           	<%
  		...
  		%>
              ...
              <title>Delete Category - Couponic Admin</title>
 ...
 <!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <ul class="nav navbar-nav navbar-right navbar-user">
      ...
      <div id="page-wrapper">
		...
		<div class="row">
          <div class="col-lg-6">
  <form role="form" action="${pageContext.request.contextPath}/CouponsController/adminController" name="deleteCategoryForm"  method="POST" onsubmit="return checkForm();" >
	  		  <input type="hidden" name="controller" class="form-control" value="deleteCategory" >
	  		  <input type="hidden" name="className" value="Category"> 
              <div class="form-group">
                <label>Category id</label>
                <input type="text" name="id" class="form-control" placeholder="Enter id To delte" >
              </div>
...
// function that check the form validation  and shows alert to the Client	 
	 function checkForm()
	  {
	    var id = document.deleteCategoryForm.id.value; //ID describes the ID of the Category to delete
		...
		var flag = true;									//flag describes if  all details are valid or not 
			...
			if ((isEmpty(id)) == true ||(checkString(okNum, id)) == false)
			{
				 ...
				 document.deleteCategoryForm.id.value;
				 flag = false;
			}
