<%@ page language="java" contentType="text/html; charset=windows-1255"
 ...
 <%@page import ="java.util.*" %>
      <%@ page isErrorPage="false" errorPage="errorAdminPage.jsp"%>
 
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    
 <%-- this JSP page  is managed by the Admin, responsible for Update proper Coupon 
	...
	<head>   
        <%
  		...
  		%>
              ...
              <title>Update Coupon - Couponic Admin</title>
          ...
          <div id="wrapper">
              ...
              <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                  ...
                  <div class="navbar-header">
                      <a class="navbar-brand" href="index.html">Admin-Couponic</a>
                  </div>
 <!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <ul class="nav navbar-nav navbar-right navbar-user">
            ...
            <li class="dropdown user-dropdown">
              ...
              <ul class="dropdown-menu">            
                <li class="divider"></li>
                 <form role="form" action="${pageContext.request.contextPath}/CouponsController/logout" method="POST" >
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Update Coupon<small></small></h1>
            <ol class="breadcrumb">
              <li><a href="${pageContext.request.contextPath}/couponAdmin/couponAdmin.jsp"><i class="icon-dashboard"></i> Dashboard</a></li>
              <li class="active"><i class="icon-file-alt"></i>Update the coupon By id </li>
            </ol>
          </div>
        </div><!-- /.row -->
		<div class="row">
          <div class="col-lg-6">
            <form role="form" action="${pageContext.request.contextPath}/CouponsController/adminController" name="updateCouponForm"  method="POST" onsubmit="return checkForm();" >
	  		  <input type="hidden" name="controller" class="form-control" value="updateCoupon" >
              <div class="form-group">
                <label>Coupon id</label>
                <input type="text" name="id" class="form-control" placeholder="Enter Coupon Id To Update" >
              </div>
              
			  <div class="form-group">
                <label>coupon Name</label>
                <input type="text" name="couponName" class="form-control" placeholder="Enter Coupon Name" >
              </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
                <label>Price</label>
                <input type="text" name="price" class="form-control" placeholder="Enter Private" >
              </div>
			  	<div class="form-group">
...
ArrayList<Object> listCategories = (ArrayList<Object>)request.getAttribute("allCategories");
  ...
  function checkForm()
  {
    ...
    var id = document.updateCouponForm.id.value;				//ID describes the ID of the Coupon and is unique for every Coupon 
	var price = document.updateCouponForm.price.value;			//price  describes the price of the Coupon in dollar 
	var details = document.updateCouponForm.Details.value;		 // details describes  describes of the Coupon 
	var latitudeFromUser = document.updateCouponForm.LatitudeFromUser.value; // latitude describes  latitude of the Coupon
	var longitudeFromUser = document.updateCouponForm.LongitudeFromUser.value;  // longitude describes  longitude of the Coupon
	var couponName = document.updateCouponForm.couponName.value;	// couponName describes  the name  of the Coupon
	var image = document.updateCouponForm.image.value;				// image describes  image of the Coupon by given url 
	var date = document.updateCouponForm.Date.value;				// date describes the last date of expire of the Coupon
	var time = document.updateCouponForm.time.value;			// time describes the last time of expire of the Coupon
	var choosenDate =Date.parse(date);							// choosenDate describes choosen Date of expire of the Coupon after parse
	var business = document.updateCouponForm.business.value;    // business describes the business object that coupon belong too
	var categories = document.updateCouponForm.categories.value; // categories describes the categories object that coupon belong to
	...
	//check id field is empty or it is not a number and Displaying Appropriate message to client 
		if ((isEmpty(id)) == true ||(checkString(okNum, id)) == false)
		{
			 ...
			 document.updateCouponForm.id.value;
			 flag = false;
		}
	...
	//check latitude field is empty  and Displaying Appropriate message to client 
		if ((isEmpty(latitudeFromUser)) == true)
		{
			 ...
			 document.updateCouponForm.LatitudeFromUser.value;
			 flag = false;
		}
		...
		if ((isEmpty(longitudeFromUser)) == true)
		{
			 ...
			 document.updateCouponForm.LongitudeFromUser.value;
			 flag = false;
		}
		...
		if ((isEmpty(couponName)) == true )
		{
			 ...
			 document.updateCouponForm.price.value;
			 flag = false;
		}
		...
		{
			 alert('image: you need to insert valid integet number');
			 document.updateCouponForm.image.value;
			 flag = false;
		}
	//check business field is empty  and Displaying Appropriate message to client
		if ((isEmpty(business)) == true )
		{
			 ...
			 document.updateCouponForm.business.value;
			 flag = false;
		}
		...
		if ((isEmpty(categories)) == true )
		{
			 ...
			 document.updateCouponForm.categories.value;
			 flag = false;
		}
...
//check if choosenDate smaller then today date (if choosenDate is valid)  and Displaying Appropriate message to client
	...
	if(flag == true)
    {
		alert("this is your details,Click ok and wait to approval :\n"+"id:"+id+"\n"+
				"date:" +date+ "\n"+
				"time:" +time+"\n"+
				"price:" +price+"\n"+
